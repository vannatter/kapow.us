...
<div class="row">
	<div class="span6 item_detail_img">	
		<?php if ($item['Item']['img_fullpath'] == "/img/covers") { ?><img alt="<?php echo $item['Item']['item_name']; ?>" src="/theme/Kapow/img/nocover_large.png" class="detail_img" /><?php } else { ?><img alt="<?php echo $item['Item']['item_name']; ?>" class="detail_img" src="<?php echo $this->Common->thumb($item['Item']['img_fullpath'], "50p"); ?>?<?php echo $this->Common->randstr(10); ?>" /><?php } ?>
	</div>
