<div class="my_block">
	...
	<?php foreach ($pulls as $pull) { ?>
		...
		<div class="span2 my_block">
			<div class="preview_img"><a href="/items/<?php echo $this->Common->seoize($pull['Item']['id'], $pull['Item']['item_name']); ?>"><?php if ($pull['Item']['img_fullpath'] == "/img/covers") { ?><img border="0" alt="<?php echo $pull['Item']['item_name']; ?>" src="/img/nocover.png" width="210" height="140" /><?php } else { ?><img border="0" alt="<?php echo $pull['Item']['item_name']; ?>" src="<?php echo $this->Common->thumb($pull['Item']['img_fullpath']); ?>" /><?php } ?></a></div>
