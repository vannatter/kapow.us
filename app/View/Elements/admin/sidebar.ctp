...
<div class="well">
	<ul class="nav nav-list">
		...
		<li><?php echo $this->Html->link(__('Improvements <span class="badge %s">%s</span>', ($newImprovementsTotal>0) ? 'badge-success' : '', $newImprovementsTotal), array('controller' => 'admin', 'action' => 'improvements'), array('escape' => false)); ?></li>
		<li class="divider"></li>
